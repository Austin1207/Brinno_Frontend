...
const IconObstacleLine2 = createSvgIcon(
    <svg width="24" height="24" viewBox="0 0 24 24" fill="#none" xmlns="http://www.w3.org/2000/svg">
        <path d="M3 12h18" stroke="#b9bbbc" stroke-width="3"/>
    </svg>,
    'ObstacleLine',
);
...
export {IconConstructionLine, IconInterestLine, IconObstacleLine, IconNoCamLine, IconMustLine, IconConstructionLine2, IconObstacleLine2, IconNoCamLine2, IconMustLine2};