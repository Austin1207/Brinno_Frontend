...
function TargetFactory(name, info) {
  ...
  var targetElement = {
    ...
    render2D: function render2D(element, layer, scene) {
      ...
      return element.selected ? _react2.default.createElement('line', { x1: '0', y1: '0', x2: length, y2: '0', style: STYLE_LINE_SELECTED, strokeDasharray: '20' }) : _react2.default.createElement('line', { x1: '0', y1: '0', x2: length, y2: '0', style: STYLE_LINE, strokeDasharray: '20' });
    },
