...
var _toolbarLoadImage = require('./toolbar-load-image');

var _toolbarLoadImage2 = _interopRequireDefault(_toolbarLoadImage);
  ...
  _createClass(Toolbar, [{
    ...
    value: function render() {
      ...
      //test
      {
        ...
        dom: _react2.default.createElement(_toolbarLoadImage2.default, { state: state })
      }];
