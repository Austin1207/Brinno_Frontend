...
var ToolbarButton = (0, _styles.styled)(_Button2.default)({
  maxWidth: '59px',
  maxHeight: '59px',
  minWidth: '59px',
  minHeight: '59px',
...
var IconConstruction = (0, _utils.createSvgIcon)(_react2.default.createElement(
  'svg',
  { width: '24', height: '24', viewBox: '0 0 24 24', xmlns: 'http://www.w3.org/2000/svg' },
  _react2.default.createElement('path', { d: 'M4.32 4.32h1.44v0.96h-0.48v0.48H4.32V4.32zm0 13.92v1.44h1.44v-0.96h-0.48v-0.48H4.32zm13.92 1.44h1.44v-1.44h-0.96v0.48h-0.48v0.96zm1.44 -13.92V4.32h-1.44v0.96h0.48v0.48h0.96zM7.2 4.32v1.44h1.92V4.32h-1.92zm3.84 0v1.44h1.92V4.32h-1.92zm3.84 0v1.44h1.92V4.32h-1.92zm4.8 2.88h-1.44v1.92h1.44v-1.92zm0 3.84h-1.44v1.92h1.44v-1.92zm0 3.84h-1.44v1.92h1.44v-1.92zm-2.88 4.8v-1.44h-1.92v1.44h1.92zm-3.84 0v-1.44h-1.92v1.44h1.92zm-3.84 0v-1.44h-1.92v1.44h1.92zM4.32 16.8h1.44v-1.92H4.32v1.92zm0 -3.84h1.44v-1.92H4.32v1.92zm0 -3.84h1.44v-1.92H4.32v1.92z' })
), 'Construction');
var IconInterest = (0, _utils.createSvgIcon)(_react2.default.createElement(
  'svg',
  { width: '24', height: '24', viewBox: '0 0 24 24', xmlns: 'http://www.w3.org/2000/svg' },
  _react2.default.createElement('path', { d: 'M4.32 4.32h1.44v0.96h-0.48v0.48H4.32V4.32zm0 13.92v1.44h1.44v-0.96h-0.48v-0.48H4.32zm13.92 1.44h1.44v-1.44h-0.96v0.48h-0.48v0.96zm1.44 -13.92V4.32h-1.44v0.96h0.48v0.48h0.96zM7.2 4.32v1.44h1.92V4.32h-1.92zm3.84 0v1.44h1.92V4.32h-1.92zm3.84 0v1.44h1.92V4.32h-1.92zm4.8 2.88h-1.44v1.92h1.44v-1.92zm0 3.84h-1.44v1.92h1.44v-1.92zm0 3.84h-1.44v1.92h1.44v-1.92zm-2.88 4.8v-1.44h-1.92v1.44h1.92zm-3.84 0v-1.44h-1.92v1.44h1.92zm-3.84 0v-1.44h-1.92v1.44h1.92zM4.32 16.8h1.44v-1.92H4.32v1.92zm0 -3.84h1.44v-1.92H4.32v1.92zm0 -3.84h1.44v-1.92H4.32v1.92z' }),
  _react2.default.createElement('path', { d: 'M7.68 7.68h8.64v8.64H7.68V7.68z' })
), 'Interest');
var IconObstacle = (0, _utils.createSvgIcon)(_react2.default.createElement(
  'svg',
  { width: '24', height: '24', viewBox: '0 0 24 24', xmlns: 'http://www.w3.org/2000/svg' },
  _react2.default.createElement('path', { d: 'M12.17 1.745c-5.386 0 -9.754 4.368 -9.754 9.754c0 5.386 4.368 9.754 9.754 9.754s9.754 -4.368 9.754 -9.754C21.924 6.11 17.556 1.745 12.17 1.745zM18.266 13.327h-12.192V9.67h12.192V13.327z' })
), 'Obstacle');
var IconNoCam = (0, _utils.createSvgIcon)(_react2.default.createElement(
  'svg',
  { width: '24', height: '24', viewBox: '0 0 24 24', xmlns: 'http://www.w3.org/2000/svg' },
  _react2.default.createElement('path', { d: 'M20.1 8.55v8.371l-1.35 -1.186v-7.186a0.15 0.15 0 0 0 -0.15 -0.15h-3.503l-0.321 -0.896 -0.429 -1.204h-4.697l-0.391 1.096 -1.091 -0.959 0.39 -1.09a0.599 0.599 0 0 1 0.564 -0.398h5.752a0.601 0.601 0 0 1 0.566 0.398l0.608 1.702h2.55a1.5 1.5 0 0 1 1.5 1.5zM12 9.6a2.999 2.999 0 0 1 2.995 2.836l-3.217 -2.828c0.073 -0.005 0.147 -0.008 0.222 -0.008zm-1.549 2.083 2.657 2.335a1.8 1.8 0 0 1 -2.657 -2.335zm-0.911 -0.801a2.987 2.987 0 0 0 -0.54 1.718A2.999 2.999 0 0 0 12 15.6c0.778 0 1.487 -0.296 2.019 -0.781l2.766 2.431H5.4a0.15 0.15 0 0 1 -0.15 -0.15V8.55c0 -0.082 0.068 -0.15 0.15 -0.15h1.315l2.825 2.482zm-4.345 -3.818a1.5 1.5 0 0 0 -1.295 1.486v8.55a1.5 1.5 0 0 0 1.5 1.5h12.922l0.827 0.726a0.72 0.72 0 1 0 0.95 -1.081L5.341 5.275a0.72 0.72 0 1 0 -0.95 1.082l0.804 0.707z' })
), 'NoCam');
var IconMust = (0, _utils.createSvgIcon)(_react2.default.createElement(
  'svg',
  { width: '24', height: '24', viewBox: '0 0 24 24', xmlns: 'http://www.w3.org/2000/svg' },
  _react2.default.createElement('path', { d: 'M4.32 8.16V4.32h3.84v1.44h-2.4v2.4H4.32zm15.36 0V4.32h-3.84v1.44h2.4v2.4h1.44zm0 7.68h-1.44v2.4h-2.4v1.44h3.84v-3.84zm-11.52 3.84v-1.44h-2.4v-2.4H4.32v3.84h3.84zm3.36 -6.72h-2.4v-1.44h2.4v-2.4h1.44v2.4h2.4v1.44h-2.4v2.4h-1.44v-2.4z' })
), 'Must');
var IconAddCam = (0, _utils.createSvgIcon)(_react2.default.createElement(
  'svg',
  { width: '24', height: '24', viewBox: '0 0 24 24', xmlns: 'http://www.w3.org/2000/svg' },
  _react2.default.createElement('path', { d: 'M16.05 7.05h2.55a1.5 1.5 0 0 1 1.5 1.5v3.434a4.734 4.734 0 0 0 -1.35 -0.803v-2.631a0.15 0.15 0 0 0 -0.15 -0.15h-3.503l-0.75 -2.1h-4.697L8.901 8.4H5.4a0.15 0.15 0 0 0 -0.15 0.15v8.55c0 0.083 0.068 0.15 0.15 0.15h7.199a4.731 4.731 0 0 0 0.776 1.35H5.4a1.5 1.5 0 0 1 -1.5 -1.5V8.55a1.5 1.5 0 0 1 1.5 -1.5h2.55l0.609 -1.702a0.599 0.599 0 0 1 0.564 -0.398h5.752a0.601 0.601 0 0 1 0.566 0.398l0.608 1.702z' }),
  _react2.default.createElement('path', { d: 'M14.769 11.442A3 3 0 0 0 12 9.6a2.999 2.999 0 0 0 -3 3 2.999 2.999 0 0 0 3.303 2.985 4.742 4.742 0 0 1 0.17 -1.248 1.8 1.8 0 0 1 -2.273 -1.737 1.8 1.8 0 0 1 3.553 -0.41 4.751 4.751 0 0 1 1.016 -0.747z' }),
  _react2.default.createElement('path', { 'fill-rule': 'evenodd', 'clip-rule': 'evenodd', d: 'M19.504 14.183c0.24 0.418 0.378 0.901 0.378 1.417a2.829 2.829 0 0 1 -0.378 1.417 2.856 2.856 0 0 1 -1.048 1.047c-0.417 0.24 -0.901 0.377 -1.416 0.377h-0.001a2.829 2.829 0 0 1 -1.418 -0.379 2.856 2.856 0 0 1 -1.045 -1.045 2.83 2.83 0 0 1 -0.378 -1.418c0 -0.516 0.138 -1.001 0.378 -1.418a2.856 2.856 0 0 1 1.045 -1.045 2.829 2.829 0 0 1 1.418 -0.379h0.001c0.516 0 0.999 0.137 1.416 0.378a2.856 2.856 0 0 1 1.048 1.047zM21.019 15.6a3.979 3.979 0 1 1 -7.958 0 3.979 3.979 0 0 1 7.958 0z' }),
  _react2.default.createElement('path', { d: 'M16.471 17.116a0.568 0.568 0 1 0 1.137 0v-0.948h0.948a0.568 0.568 0 1 0 0 -1.137h-0.948v-0.948a0.568 0.568 0 0 0 -1.137 0v0.948h-0.947a0.568 0.568 0 1 0 0 1.137h0.947v0.948z' })
), 'AddCam');
var IconSum = (0, _utils.createSvgIcon)(_react2.default.createElement(
  'svg',
  { width: '24', height: '24', viewBox: '0 0 24 24', xmlns: 'http://www.w3.org/2000/svg' },
  _react2.default.createElement('path', { 'fill-rule': 'evenodd', 'clip-rule': 'evenodd', d: 'M16.808 15.978A6.212 6.212 0 0 0 18.222 12.48h-4.594l3.18 3.498zm-1.04 0.996A6.213 6.213 0 0 1 12 18.24c-3.446 0 -6.24 -2.794 -6.24 -6.24 0 -3.203 2.413 -5.842 5.52 -6.199V11.76c0 0.179 0.067 0.352 0.187 0.484l4.301 4.73zM12 4.32C7.758 4.32 4.32 7.758 4.32 12s3.438 7.68 7.68 7.68 7.68 -3.438 7.68 -7.68S16.242 4.32 12 4.32zm0.72 1.481V11.04h5.447c-0.426 -2.757 -2.656 -4.918 -5.447 -5.239z' })
), 'Sum');
  ...
  */
  ...
  _createClass(Toolbar, [{
    ...
    value: function render() {
      ...
      var sorter = [{
        index: 0, condition: true, dom: _react2.default.createElement(
          _Box2.default,
          { pb: 5 / 8 },
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              { id: 'Outline Construction Area1',
                sx: this.state.inuseTool == 'construction area' && ([_constants.MODE_WAITING_DRAWING_LINE].includes(mode) || [_constants.MODE_DRAWING_LINE].includes(mode)) ? buttonsInuseStyle : buttonsStyle,
                onClick: function onClick(event) {
                  return DrawConstructionArea();
                },
                disabled: true
              },
              _react2.default.createElement(IconConstruction, { sx: { fontSize: 40 } })
            )
          ),
          _react2.default.createElement(
            _Tooltip2.default,
        ...
        index: 1, condition: true, dom: _react2.default.createElement(_Divider2.default, null)
      }, {
        index: 2, condition: true, dom: _react2.default.createElement(
          _Box2.default,
          { pt: 5 / 8, pb: 5 / 8 },
          _react2.default.createElement(
            _Tooltip2.default,
            ...
            _react2.default.createElement(
              ...
              { id: 'Outine Interest Area1',
                sx: this.state.inuseTool == 'interest area' && ([_constants.MODE_WAITING_DRAWING_LINE].includes(mode) || [_constants.MODE_DRAWING_LINE].includes(mode)) ? buttonsInuseStyle : buttonsStyle,
                onClick: function onClick(event) {
              ...
              _react2.default.createElement(IconInterest, { sx: { fontSize: 40 } })
            )
          ),
          _react2.default.createElement(
            _Tooltip2.default,
        ...
        index: 3, condition: true, dom: _react2.default.createElement(_Divider2.default, null)
      }, {
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              { id: 'Place Obstacle Area1',
                sx: this.state.inuseTool == 'obstacle area' && ([_constants.MODE_WAITING_DRAWING_LINE].includes(mode) || [_constants.MODE_DRAWING_LINE].includes(mode)) ? buttonsInuseStyle : buttonsStyle,
                onClick: function onClick(event) {
                  return DrawObstacleArea();
                },
                disabled: true
              },
              _react2.default.createElement(IconObstacle, { sx: { fontSize: 40 } })
            )
          ),
          _react2.default.createElement(
            _Tooltip2.default,
        ...
        index: 5, condition: true, dom: _react2.default.createElement(_Divider2.default, null)
      }, {
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              { id: 'Place no-camera area1',
                sx: this.state.inuseTool == 'nocamera area' && ([_constants.MODE_WAITING_DRAWING_LINE].includes(mode) || [_constants.MODE_DRAWING_LINE].includes(mode)) ? buttonsInuseStyle : buttonsStyle,
                onClick: function onClick(event) {
                  return DrawNoCameraArea();
                },
                disabled: true
              },
              _react2.default.createElement(IconNoCam, { sx: { fontSize: 40 } })
            )
          ),
          _react2.default.createElement(
            _Tooltip2.default,
        ...
        index: 7, condition: true, dom: _react2.default.createElement(_Divider2.default, null)
      }, {
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              { id: 'Place must-cover area1',
                sx: this.state.inuseTool == 'mustcover area' && ([_constants.MODE_WAITING_DRAWING_LINE].includes(mode) || [_constants.MODE_DRAWING_LINE].includes(mode)) ? buttonsInuseStyle : buttonsStyle,
                onClick: function onClick(event) {
                  return DrawMustcoverArea();
                },
                disabled: true
              },
              _react2.default.createElement(IconMust, { sx: { fontSize: 40 } })
            )
          ),
          _react2.default.createElement(
            _Tooltip2.default,
        ...
        index: 9, condition: true, dom: _react2.default.createElement(_Divider2.default, null)
      }, {
        index: 10, condition: true, dom: _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(IconAddCam, { sx: { fontSize: 40 } })
            )
          ),
          _react2.default.createElement(
            _Tooltip2.default,
        ...
        index: 11, condition: true, dom: _react2.default.createElement(_Divider2.default, null)
      }];
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(IconSum, { sx: { fontSize: 40 } })
            ),
            _react2.default.createElement(
              _Button2.default,
              {
