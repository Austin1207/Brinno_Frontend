...
var _preview = require('./preview.png');

var _preview2 = _interopRequireDefault(_preview);

var _optimizing = require('./components/loading/optimizing');

var _optimizing2 = _interopRequireDefault(_optimizing);
  ...
  _createClass(ReactPlanner, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { style: { height: height } },
        _react2.default.createElement(_export3.Loading, { left: (contentW - 100) / 2 }),
        _react2.default.createElement(_optimizing2.default, { left: (contentW - 100) / 2 }),
        _react2.default.createElement('div', { style: {
            width: contentW,
            height: 64,
            zIndex: 9999
          } }),
        _react2.default.createElement(_export3.InitialScreen, _extends({ state: extractedState, left: (contentW - 320) / 2, jsonleft: width / 2, top: height / 2 }, props)),
        _react2.default.createElement(_export3.TutorialScale, _extends({ state: extractedState, left: contentW }, props)),
        _react2.default.createElement(
          'div',
          { style: _extends({}, wrapperStyle) },
          _react2.default.createElement(Toolbar, _extends({ width: toolbarW, height: contentH - 56, state: extractedState }, props, { showCamDrawer: showCamDrawer, showSumDrawer: showSumDrawer, updateCam: this.getShowCamDrawer, updateSum: this.getShowSumDrawer })),
          _react2.default.createElement(_export3.Content, _extends({ width: contentW, height: contentH - 56, state: extractedState }, props, { onWheel: function onWheel(event) {
              return event.preventDefault();
            } }))
        ),
        _react2.default.createElement(_export3.TopBar, _extends({ state: extractedState }, props, { showCamDrawer: showCamDrawer, showSumDrawer: showSumDrawer })),
        _react2.default.createElement(_export3.BottomButtonGroup, _extends({ state: extractedState }, props)),
        _react2.default.createElement(Sidebar, _extends({ width: sidebarW, height: 75, left: (contentW - 431) / 2, state: extractedState, display: "none" }, props))
