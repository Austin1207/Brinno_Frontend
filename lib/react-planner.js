  ...
  _createClass(ReactPlanner, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_export3.InitialScreen, _extends({ state: extractedState, left: (contentW - 320) / 2 }, props)),
        _react2.default.createElement(_export3.TutorialScale, _extends({ state: extractedState, left: contentW }, props)),
        _react2.default.createElement(_export3.ResponsiveAppBar, _extends({ state: extractedState }, props)),
        ...
        _react2.default.createElement(_export3.LineSpeedDial, _extends({ state: extractedState }, props)),
        _react2.default.createElement(_export3.CameraSpeedDial, _extends({ state: extractedState }, props)),
        _react2.default.createElement(Sidebar, _extends({ display: 'none', width: sidebarW, height: 75, left: (contentW - 520) / 2, state: extractedState }, props))
