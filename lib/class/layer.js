  ...
  _createClass(Layer, null, [{
    ...
    value: function detectAndUpdateAreas(state, layerID) {
      ...
      if (allX.length != 0 & firstArea) {
        ...
        state = _export.Item.create(state, layerID, 'camera_BCC2000', Xmax - 10, Ymax - 10, 200, 100, -45).updatedState;
        state = _export.Item.create(state, layerID, 'camera_BCC2000', Xmax - 10, Ymin + 10, 200, 100, -135).updatedState;
        state = _export.Item.create(state, layerID, 'camera_BCC2000', Xmin + 10, Ymax - 10, 200, 100, 45).updatedState;
        state = _export.Item.create(state, layerID, 'camera_BCC2000', Xmin + 10, Ymin + 10, 200, 100, 135).updatedState;
