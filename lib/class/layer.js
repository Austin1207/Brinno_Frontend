  ...
  _createClass(Layer, null, [{
    ...
    value: function detectAndUpdateAreas(state, layerID) {
      ...
      if (allX.length != 0 & firstArea) {
        ...
        state = _export.Item.create(state, layerID, 'camera_BAC2000', Xmax, Ymax, 200, 100, -45).updatedState;
        state = _export.Item.create(state, layerID, 'camera_BAC2000', Xmax, Ymin, 200, 100, -135).updatedState;
        state = _export.Item.create(state, layerID, 'camera_BAC2000', Xmin, Ymax, 200, 100, 45).updatedState;
        state = _export.Item.create(state, layerID, 'camera_BAC2000', Xmin, Ymin, 200, 100, 135).updatedState;
      }
